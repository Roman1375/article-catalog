...
A Single Page Application (SPA) built with **React** and **TypeScript** for browsing space news with intelligent search
...
**Live Demo:** [https://astounding-kleicha-d5776f.netlify.app/](https://astounding-kleicha-d5776f.netlify.app/)
...
- **Smart Search**: The search query is split into individual keywords. Priority is given to matches in titles (weight:
  10) over matches in descriptions (weight: 1).
